    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="relative">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white">
          <h1 className="text-4xl font-bold mb-4 text-white">Find Your Perfect Fit</h1>
          <p className="text-lg mb-8 text-white">Explore our latest collection</p>
      ...
      <div className="py-12 px-4 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {/* Product Card */}
          <div className="bg-white shadow-lg rounded-lg overflow-hidden transition-transform transform hover:-translate-y-2">
            <img
              src={heroImage2}
              alt="Product 1"
          ...
          <div className="bg-white shadow-lg rounded-lg overflow-hidden transition-transform transform hover:-translate-y-2">
            ...
            <div className="p-4">
              <h3 className="text-xl font-semibold mb-2 text-red-900">Product 1</h3>
              <p className="text-gray-600 mb-4">$99.99</p>
              <button className="bg-red-500 text-white py-2 px-4 rounded-lg hover:bg-red-800">
                View Details
              </button>
            </div>
          </div>
      ...
      <div className="bg-black text-white py-12 text-center">
        ...
        <a href="/signup"><button className="bg-white text-red-900 py-2 px-4 rounded-lg hover:bg-gray-200">
          Subscribe Now
        </button></a>
      </div>
    </div>
